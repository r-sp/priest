...
const colorGreen: ColorShadeList = [
  ...
  { hex: "#477050", rgb: { r: 71, g: 112, b: 80 }, label: "Hungarian Green" },
  { hex: "#355e3b", rgb: { r: 53, g: 94, b: 59 }, label: "Hunter Green" },
  { hex: "#138808", rgb: { r: 19, g: 136, b: 8 }, label: "India Green" },
  { hex: "#009000", rgb: { r: 0, g: 144, b: 8 }, label: "Islamic Green" },
  { hex: "#18353b", rgb: { r: 24, g: 69, b: 59 }, label: "MSU Green" },
  { hex: "#0d5c33", rgb: { r: 13, g: 92, b: 51 }, label: "NDHU Green" },
  { hex: "#01411c", rgb: { r: 1, g: 65, b: 28 }, label: "Pakistan Green" },
  { hex: "#00a693", rgb: { r: 0, g: 166, b: 147 }, label: "Persian Green" },
  { hex: "#444c38", rgb: { r: 68, g: 76, b: 56 }, label: "Riffle Green" },
  { hex: "#679267", rgb: { r: 103, g: 146, b: 103 }, label: "Russian Green" },
...
const colorBlue: ColorShadeList = [
  ...
  { hex: "#4b61d1", rgb: { r: 75, g: 97, b: 208 }, label: "Savory Blue" },
  { hex: "#0000cd", rgb: { r: 0, g: 0, b: 205 }, label: "Medium Blue" },
  { hex: "#0085ca", rgb: { r: 0, g: 133, b: 202 }, label: "Process Blue C" },
  { hex: "#545aa7", rgb: { r: 84, g: 90, b: 167 }, label: "Liberty" },
  { hex: "#1034a6", rgb: { r: 16, g: 52, b: 166 }, label: "Egyptian Blue" },
  { hex: "#002fa7", rgb: { r: 0, g: 47, b: 167 }, label: "International Klein Blue" },
  ...
  { hex: "#4c516d", rgb: { r: 76, g: 81, b: 109 }, label: "Independence" },
  { hex: "#002e63", rgb: { r: 0, g: 46, b: 99 }, label: "Cool Black (PMS 295)" },
  ...
  { hex: "#6cb4ee", rgb: { r: 108, g: 180, b: 238 }, label: "Argentinian Blue" },
  { hex: "#76abdf", rgb: { r: 118, g: 171, b: 223 }, label: "Ruddy Blue" },
  { hex: "#246bce", rgb: { r: 36, g: 107, b: 206 }, label: "Celtic Blue" },
  { hex: "#0070b8", rgb: { r: 0, g: 112, b: 184 }, label: "Spanish Blue" },
  { hex: "#318ce7", rgb: { r: 49, g: 140, b: 231 }, label: "Bleu de France" },
  { hex: "#1f305e", rgb: { r: 31, g: 48, b: 94 }, label: "Delft Blue" },
  { hex: "#007791", rgb: { r: 0, g: 119, b: 145 }, label: "Duck Blue" },
  { hex: "#002387", rgb: { r: 0, g: 35, b: 135 }, label: "Resolution Blue" },
  { hex: "#224c98", rgb: { r: 34, g: 76, b: 152 }, label: "Polynesian Blue" },
  { hex: "#468fea", rgb: { r: 70, g: 143, b: 234 }, label: "Chefchaouen Blue" },
  ...
  { hex: "#4997d0", rgb: { r: 73, g: 151, b: 208 }, label: "Celestial Blue" },
  { hex: "#7c9ed9", rgb: { r: 124, g: 158, b: 217 }, label: "Vista Blue" },
  { hex: "#5d89ba", rgb: { r: 93, g: 137, b: 186 }, label: "Silver Lake Blue" },
  { hex: "#4682b4", rgb: { r: 70, g: 130, b: 180 }, label: "Steel Blue" },
  { hex: "#26619c", rgb: { r: 38, g: 97, b: 156 }, label: "Lapis Lazuli" },
];
