    ...
    <div role="none" className="relative block h-7">
      ...
      >
        <fieldset
          ...
          className="pointer-events-auto flex flex-nowrap items-center gap-3 font-mono text-sm font-medium select-none"
        >
      ...
      <span
        aria-hidden="true"
        className="absolute -top-2 -bottom-2 -left-4 z-1 w-4 bg-linear-to-r from-gray-50 to-gray-950/0 dark:from-gray-950"
      ></span>
      <span
        aria-hidden="true"
        className="absolute -top-2 -right-4 -bottom-2 z-1 w-4 bg-linear-to-l from-gray-50 to-gray-950/0 dark:from-gray-950"
      ></span>
    </div>
  );
}
